...
@app.post("/activities")
def add_activity(name: str, description: str, schedule: str, max_participants: int, current_user: User = Depends(get_admin_user)):
    ...
    return {"message": f"Added activity {name}"}
